...
function [ x, u_num, mass, energy, u_exact, x_eval ] = solve_linear_SAT_inflow( x_L, x_R, T, u_init, I, approx_space, K, points, x_eval )
    ...
    u_exact = u_init(x_eval-T)+u_init(x_eval); % reference solution 
